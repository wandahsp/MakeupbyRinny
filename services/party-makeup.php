...
<html lang="id">
  ...
  <body>
    ...
    <section class="gallery">
      ...
      <a href="tambahfotoparty.php" class="upload-link">Unggah Gambar</a> <!-- Link ke halaman upload -->
      <a href="hapusfotoparty.php" class="upload-link">Hapus Gambar</a> <!-- Link ke halaman hapus -->
      <div class="gallery-images">
        <?php
        if ($result->num_rows > 0) {
            // Menampilkan gambar
            while ($row = $result->fetch_assoc()) {
                echo "<img src='partymakeup/" . $row['image_name'] . "' alt='Gallery Image' />";
            }
        } else {

...
<body>
    ...
    <section class="gallery">
        ...
        <a href="tambahfotobridal.php" class="upload-link">Unggah Gambar</a> <!-- Link ke halaman upload -->
        <a href="hapusfotobridal.php" class="upload-link">Hapus Gambar</a> <!-- Link ke halaman hapus -->
        <div class="gallery-images">
            <?php
            if ($result->num_rows > 0) {
                // Menampilkan gambar
                while ($row = $result->fetch_assoc()) {
                    echo "<img src='bridalmakeup/" . $row['image_name'] . "' alt='Gallery Image' />";
                }
            } else {
